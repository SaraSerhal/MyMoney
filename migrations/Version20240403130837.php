 ...
 */
final class Version20240403130837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expenses_category DROP category_name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expenses_category ADD category_name VARCHAR(255) NOT NULL');
    }
}
